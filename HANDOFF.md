...
- **MainButton не мигает**: useMainButton разнесён на 3 эффекта — hide только при размонтировании,
  параметры через setParams «на месте», onClick отдельно. НЕ возвращать hide/show в эффект параметров!
- В Настройках MainButton «Сохранить» виден только при несохранённых изменениях (dirty-сравнение).
